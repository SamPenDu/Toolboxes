function OutStim = RemoveCentral(InStim,Num)
%OutStim = RemoveCentral(InStim,Num)
%
% Picks elements in order of ascending eccentricity.
%
% Parameters:
%   InStim :   Input stimulus struct
%   Ori :      Remaining number of elements
%
