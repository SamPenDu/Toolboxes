function bf_samgam_multap(FreqBand, GridSize, SpmFileName)
%% repeated measures
...
%     xlabel('Time (s)');
%     ylabel('Frequency (Hz)'); 
%     saveas(gcf,['tf_' hemistr '_' num2str(FreqBand(1)) '-' num2str(FreqBand(2)) '_' num2str(GridSize) '_mt.fig']);
    tfd = [tfimg(:,1201:1800)-tfimg(:,301:900)]';
%     figure; errorplot(0:99, mean(tfd), sem(tfd), [0 0 0]);
    [m tff]=max(mean(tfd));
    tff = tff-1;
%     hold on; line([tff tff], ylim, 'color', 'r');
%     saveas(gcf,['tfd_' hemistr '_' num2str(FreqBand(1)) '-' num2str(FreqBand(2)) '_' num2str(GridSize) '_mt.fig']);
...
%     ylabel('Power');
%     xlim(FreqBand);
%     saveas(gcf,[hemistr '_' num2str(FreqBand(1)) '-' num2str(FreqBand(2)) '_' num2str(GridSize) '_mt.fig']);
%     save([hemistr '_' num2str(FreqBand(1)) '-' num2str(FreqBand(2)) '_' num2str(GridSize) '_mt']);
