function [pout, bf10] = BinomTest(s,n,p,Sided)
%[pout bf10] = BinomTest(s,n,p,Sided)
%
...
%       Sided-  (String) can be 'one' (the default), 'two', or 'two, equal 
...
%               will perform a two-sided test that the actual number of 
%               success is different from the expected number of successes 
%               in any direction.
%
% Outputs:
...
%
% 06/01/2016: Modified by DSS to change default settings and function name. 
%             Also added output of Bayes Factor for binomial test.
%


if nargin<4 || isempty(Sided);    Sided='one';      end
